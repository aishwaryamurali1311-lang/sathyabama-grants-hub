    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: 'Welcome to the Revenue Monitoring Portal',
        });
        navigate('/home');
      } else {
        toast({
          title: 'Login failed',
          description: 'Invalid email or password. Try: test@test.com, csehod@test.com, or dean@test.com',
          variant: 'destructive',
        });
      }
    } catch (error) {
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-muted rounded-lg">
              ...
              <div className="text-xs text-center space-y-1">
                <p><strong>Faculty:</strong> test@test.com</p>
                <p><strong>HOD:</strong> csehod@test.com</p>
                <p><strong>Dean:</strong> dean@test.com</p>
                <p className="text-muted-foreground">(any password with 4+ characters)</p>
              </div>
            </div>
          </CardContent>
        </Card>
